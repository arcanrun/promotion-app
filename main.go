...
func main() {
	...
	router.HandleFunc("/promotions/file", controller.UploadCSV).Methods(http.MethodPost)
	router.HandleFunc("/promotions", controller.DeleteAllPromotions).Methods(http.MethodDelete)
